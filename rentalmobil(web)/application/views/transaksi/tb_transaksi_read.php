                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            ...
                            <table class="table">
                        	    ...
                        	    <tr><td>TGL_ORDER</td><td><?php echo $TGL_ORDER; ?></td></tr>
                        	    <tr><td>TOTAL_PEMBAYARAN</td><td>Rp. <?php echo number_format($TOTAL_PEMBAYARAN); ?></td></tr>
                        	    <tr><td>TGL_PEMBAYARAN</td><td><?php echo $TGL_PEMBAYARAN; ?></td></tr>
                        	    <tr><td>BUKTI_PEMBAYARAN</td><td><img src="<?php echo base_url('upload/bukti_pembayaran/'.$BUKTI_PEMBAYARAN); ?>" width="200px"></td></tr>
                        	    <tr><td>STATUS_PEMBAYARAN</td><td><?php if ($STATUS_PEMBAYARAN==0){echo "MENUNGGU PEMBAYARAN";}else{echo "SUDAH DIBAYAR"; }?></td></tr>
                        	    <tr><td>STATUS_TRANSAKSI</td><td><?php if ($STATUS_TRANSAKSI==0){echo "MENUNGGU DIPROSES";}else if($STATUS_TRANSAKSI==1){echo "BERJALAN"; }else{echo "SELESAI";}?></td></tr>
                                <tr><td>DENDA</td><td>Rp. <?php echo number_format($STATUS_TRANSAKSI); ?></td></tr>
                                <tr><td>DANA_KEMBALI</td><td>Rp. <?php echo number_format($DANA_KEMBALI); ?></td></tr>
                        	</table>
                            <br><br><br>
