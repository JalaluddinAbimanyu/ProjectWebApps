...
<div class="content-wrapper">
	    ...
	    <div class="form-group">
            <label for="datetime">TGL_ORDER <?php echo form_error('TGL_ORDER') ?></label>
            <input type="text" class="form-control" name="TGL_ORDER" id="TGL_ORDER" placeholder="TGL ORDER" value="<?php echo $TGL_ORDER; ?>" />
        </div>
	    <div class="form-group">
            <label for="decimal">TOTAL_PEMBAYARAN <?php echo form_error('TOTAL_PEMBAYARAN') ?></label>
	    ...
	    <div class="form-group">
            <label for="datetime">TGL_PEMBAYARAN <?php echo form_error('TGL_PEMBAYARAN') ?></label>
	    ...
	    <div class="form-group">
            <label for="BUKTI_PEMBAYARAN">BUKTI_PEMBAYARAN <?php echo form_error('BUKTI_PEMBAYARAN') ?></label>
	    ...
	    <div class="form-group">
            <label for="int">STATUS_PEMBAYARAN <?php echo form_error('STATUS_PEMBAYARAN') ?></label>
	    ...
	    <div class="form-group">
            <label for="int">STATUS_TRANSAKSI <?php echo form_error('STATUS_TRANSAKSI') ?></label>
